                ...
                <div className="container justify-center mx-auto px-10 lg:flex">
                    <div className="lg:mt-10 text-center lg:text-left lg:w-1/2">
                        ...
                        <div className="mt-4 md:mt-6 text-xl font-bold font-raleway">
                            <OutboundLink className="bg-primary-darker hover:text-primary rounded-full text-center text-white text-xl px-16 py-4" href={internship.registrationLink}>Register</OutboundLink>
                        </div>
                    </div>
                                    ...
                                    <Card className="mb-8 bg-white">
                                        <div className="inline-block mr-3">
                                            <p className="font-semibold text-xl">
                                                <OutboundLink className="text-gray-800" href={person.linkedin}>{person.name}</OutboundLink>
                                            </p>
                                        </div>
                                        <div className="w-4 h-4 mr-3 inline-block">
                                            <OutboundLink className="text-lg text-white" href="https://linkedin.com/company/skillbot">
