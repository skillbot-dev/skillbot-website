...
import { HeroImage } from '../svg/SvgImages'
import { ProactiveIcon, InclusiveIcon, CollaborativeIcon } from '../svg/Motifs'

export const query = graphql`
query{
  allFile (filter:{name:{regex:"/^index_/"} extension:{eq:"png"},sourceInstanceName:{eq : "images"}}){
    edges{
      node{
        name
        childImageSharp{
...
const Index = ({ data }) => {
  const findImage = (data, imageName) => {
    ...
    return imageData.find(n => (n.node.name === imageName)).node.childImageSharp.fluid
  }
    ...
    <Layout>
      ...
      <section className="pt-10 pb-16 lg:pb-10 lg:pt-10 bg-primary-lighter">
        <div className="container mx-auto text-center">
          ...
          <div className="mt-2 p-6 sm:p-6 text-lg xl:text-2xl text-left  font-montserrat">
      ...
      <SplitSection
        primarySlot={
          <div className="lg:pr-10 xl:pr-10">
        ...
        secondarySlot={
          <Image fluid={findImage(data,"index_workshops")} alt="Workshops"/>
        }
      />
      <SplitSection
        reverseOrder
        ...
        secondarySlot={
          <Image fluid={findImage(data, "index_globalorientation")} alt="Global Orientation" />
        }
      />
      <SplitSection
        primarySlot={
        ...
        secondarySlot={
          <Image fluid={findImage(data, "index_analytics")} alt="Analytics" />
        }
      />
